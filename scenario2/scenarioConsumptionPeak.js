...
async function main(){
	...
	console.log("La consommation de la communauté "+communityID+" le "+date1+" est : " + response.body);
	...
	console.log("La consommation de la communauté "+communityID+" le "+date2+" est : " + response.body);
