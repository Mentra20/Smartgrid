...
start powershell -command "[console]::windowwidth=70; [console]::windowheight=30; cd house-object | npm run start:dev" &
start powershell -command "[console]::windowwidth=70; [console]::windowheight=30; cd power-grid | npm run start:dev" &
start powershell -command "[console]::windowwidth=70; [console]::windowheight=30; cd supplier | npm run start:dev" &
start powershell -command "[console]::windowwidth=70; [console]::windowheight=30; cd scheduler | npm run start:dev" &
